...
public class ContactHintAdapter extends RecyclerView.Adapter<ContactHintAdapter.ViewHodel> implements Filterable {
    ...
    public ContactHintAdapter(Context context, List<Contact> contactsHint, List<Contact> contactsChoose) {
...
//        });
    ...
    private void addContactChoose(Contact contact) {
        newRoomActivity.addContactChoose(contact);
    }
